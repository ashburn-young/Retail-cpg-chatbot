...
class SessionContext:
    ...
    def get_conversation_summary(self) -> str:
        ...
        return f"Session with {self.turn_count} turns. Intents discussed: {intent_summary}"
...
class RedisContextStorage(ContextStorage):
    ...
    async def set(self, session_id: str, context: SessionContext) -> bool:
        ...
        try:
            ...
            await self.redis.set(f"context:{session_id}", data, ex=3600)  # 1 hour expiration
            return True
        except Exception as e:
        ...
        async def cleanup_loop():
            while True:
                try:
                    ...
                    await self.storage.cleanup_expired(self.settings.CONTEXT_TTL_MINUTES)
                except Exception as e:
